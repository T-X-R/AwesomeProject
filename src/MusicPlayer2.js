...
export default class MusicPlayer2 extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            btnModel:require('../pic/search.png'), //播放模式按钮背景图
            pic_small:'',    //小图
            pic_big:'',      //大图
            ...
            isplayBtn:require('../pic/search.png')  //播放/暂停按钮背景图
        }
    }
    //上一曲
    prevAction = (index) =>{
    ...
    playModel = (playModel) =>{
        ...
        if(playModel == 1){
            this.setState({
                btnModel:require('../pic/search.png'),//列表循环
            })
        }else if(playModel ==  2){
            this.setState({
                btnModel:require('../pic/search.png'),//随机播放
            })
        }else{
            this.setState({
                btnModel:require('../pic/search.png'),//单曲循环
            })
        }
    }
    //播放/暂停
    playAction =() => {
        ...
        if(this.state.pause == true){
            this.setState({
                isplayBtn:require('../pic/search.png')//播放
            })
        }else {
            this.setState({
                isplayBtn:require('../pic/search.png')//暂停
            })
        }
            ...
            return (
                <View style={styles.container}>
                    ...
                    <View style = {{position:'absolute',width: width}}>
                        {/*胶片光盘*/}
                        <Image source={require('../pic/play.png')} style={{width:220,height:220,alignSelf:'center'}}/>
